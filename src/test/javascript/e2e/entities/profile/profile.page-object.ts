...
export class ProfileDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('customerManagerApp.profile.delete.question'));
...
export default class ProfileComponentsPage {
  ...
  async deleteProfile() {
    ...
    expect(await profileDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/customerManagerApp.profile.delete.question/);

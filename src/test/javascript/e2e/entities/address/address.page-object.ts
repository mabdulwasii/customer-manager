...
export class AddressDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('customerManagerApp.address.delete.question'));
...
export default class AddressComponentsPage {
  ...
  async deleteAddress() {
    ...
    expect(await addressDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/customerManagerApp.address.delete.question/);

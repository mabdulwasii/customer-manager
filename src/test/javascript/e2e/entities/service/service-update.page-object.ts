...
export default class ServiceUpdatePage {
  pageTitle: ElementFinder = element(by.id('customerManagerApp.service.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  descriptionInput: ElementFinder = element(by.css('input#service-description'));
  startDateInput: ElementFinder = element(by.css('input#service-startDate'));
  agreeInput: ElementFinder = element(by.css('input#service-agree'));
  signDocUrlInput: ElementFinder = element(by.css('input#service-signDocUrl'));

...
export const ProfileDeleteDialog = (props: IProfileDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="customerManagerApp.profile.delete.question">
        <Translate contentKey="customerManagerApp.profile.delete.question" interpolate={{ id: profileEntity.id }}>

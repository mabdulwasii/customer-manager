...
export const PaymentDeleteDialog = (props: IPaymentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="customerManagerApp.payment.delete.question">
        <Translate contentKey="customerManagerApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>

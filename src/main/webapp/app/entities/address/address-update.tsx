  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="customerManagerApp.address.home.createOrEditLabel">
            <Translate contentKey="customerManagerApp.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : addressEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="streetNumberLabel" for="address-streetNumber">
                  <Translate contentKey="customerManagerApp.address.streetNumber">Street Number</Translate>
                </Label>
                <AvField id="address-streetNumber" type="text" name="streetNumber" />
              </AvGroup>
              <AvGroup>

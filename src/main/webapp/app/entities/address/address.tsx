  ...
  return (
    <div>
      <h2 id="address-heading">
        <Translate contentKey="customerManagerApp.address.home.title">Addresses</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="customerManagerApp.address.home.createLabel">Create new Address</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('customerManagerApp.address.home.search')}
                />
        ...
        {addressList && addressList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="customerManagerApp.address.home.notFound">No Addresses found</Translate>
            </div>
          )
        )}
      </div>

...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="customerManagerApp.address.delete.question">
        <Translate contentKey="customerManagerApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
